...
args.names_string="p1[NA18486]p2[HG00148]p3[AltaiNea]"

args.first_last_position_chromosome_file="/branchinecta/shared/humans/thousandgenomes/start_stop_position_autosomal_chromosomes.csv"
args.human_vcf="/branchinecta/shared/humans/thousandgenomes/ALL.chr{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz".format(args.chromosome)
args.archaic_vcf="/branchinecta/shared/humans/archaic/altai_nean_2013/AltaiNea.hg19_1000g.{}.mod.vcf.gz".format(args.chromosome)
args.introgressed_infile="/home/llopez84/confirm_intro/data/compressed_introgressed_bases_GBR-HG00148.csv.gz"
#outfile="/branchinecta/llopez84/results_human_archaic_windows/p1-${pop_one_name}_p2-${pop_two_name}_p3-${pop_three_name}-2013_window-${window_size}_${chromosome}.csv"
