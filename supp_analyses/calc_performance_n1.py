...
overlap_df = pd.read_csv(f'./round3_reviews/overlap/{n}/iua_f{f}_n{n}_rep{rep}.csv.gz')
...
overlap_df.to_csv(f'./round3_reviews/performance/{n}/iua_f{f}_n{n}_rep{rep}.csv.gz', index=False)